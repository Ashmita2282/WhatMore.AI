    ...
    <div>
      <section className="backdrop-blur-xl text-white min-h-screen flex flex-col mt-12 pt-12 items-center justify-center px-6 text-center">
        ...
        <div className="flex flex-col justify-center items-center w-[65%] leading-12">
          <h1 className="text-5xl text-black mt-8">
      ...
      <section className="bg-black text-white py-16 px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-12">
            Reflect on what’s working through analytics dashboard then pivot.
            Check AOV, Video Sales Views, Conversion rates and more
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
          <div className="text-center border-r border-gray-700 last:border-0">
            <h2 className="text-4xl font-bold text-pink-400 mb-2">
              <CountUp start={0} end={4} duration={2.5} suffix="x" />
            </h2>
            <p className="text-gray-300 text-sm uppercase tracking-wide mb-2">
              Average
            </p>
            <p className="text-lg">Increase time on site</p>
          </div>
          <div className="text-center border-r border-gray-700 last:border-0">
            <h2 className="text-4xl font-bold text-pink-400 mb-2">
            ...
            <p className="text-lg">Conversion rate increase</p>
          </div>
          <div className="text-center border-r border-gray-700 last:border-0">
            <h2 className="text-4xl font-bold text-pink-400 mb-2">
              <CountUp start={0} end={20} duration={2} prefix="+" suffix="%" />
            </h2>
            <p className="text-gray-300 text-sm uppercase tracking-wide mb-2">
              Up to
            </p>
            <p className="text-lg">AOV increase</p>
          </div>
          <div className="text-center">
            <h2 className="text-4xl font-bold text-pink-400 mb-2">Zero</h2>
            <p className="text-gray-300 text-sm uppercase tracking-wide mb-2">
              Near
            </p>
