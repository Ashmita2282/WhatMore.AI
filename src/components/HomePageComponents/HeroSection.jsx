...
function HeroSection() {
  return (
    <div className="flex flex-col justify-center items-center bg-gray-50 w-full">
      <section className="text-center pt-20 w-[60%] ">
        <h1 className="text-5xl font-semibold leading-[65px] text-center gap-1 animate-slideUp">
          Your{" "}
        ...
        <div className="mt-6 flex justify-center gap-4 text-sm animate-slideUp">
          ...
          <button className="border border-gray-400 px-6 py-2 rounded-lg flex flex-row justify-center items-center">
            <span className="pr-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="21"
